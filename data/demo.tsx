...
export const data = [
  {
    ...
    content: (
      <div>
        <p className="mb-6 text-sm md:text-base lg:text-lg leading-relaxed font-[family-name:var(--font-geist-mono)] text-neutral-800 dark:text-neutral-200 max-w-2xl">
