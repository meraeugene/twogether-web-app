...
export default function TMDBWatchPage({
  ...
  return (
    <main className="min-h-screen font-[family-name:var(--font-geist-sans)] bg-black flex flex-col px-4 pt-28 pb-16 relative lg:px-24 xl:px-16 2xl:px-26 xl:pt-34 text-white ">
