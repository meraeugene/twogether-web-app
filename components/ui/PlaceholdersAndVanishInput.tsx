  ...
  return (
    <div ref={rootRef} className="relative w-full max-w-xl mx-auto">
      ...
      {showAutocompletePanel && (
        <div className="absolute left-0 right-0 top-[calc(100%+0.6rem)] z-[120] overflow-hidden rounded-2xl border border-white/10 bg-[#0c0c0e]/fb backdrop-blur-xl shadow-[0_24px_80px_rgba(0,0,0,0.7)] animate-in fade-in zoom-in-95 duration-200">
